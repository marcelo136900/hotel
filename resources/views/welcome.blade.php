            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="5000">
                  <img src="{{asset('img/portada-1.jpg')}}" class="d-block w-100" alt="portada-1">                
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-2.jpg')}}" class="d-block w-100" alt="portada-2">                
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-3.jpg')}}" class="d-block w-100" alt="portada-3">                  
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-4.jpg')}}" class="d-block w-100" alt="portada-4">                
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-5.jpg')}}" class="d-block w-100" alt="portada-5">                
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-6.jpg')}}" class="d-block w-100" alt="portada-6">                
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-7.jpg')}}" class="d-block w-100" alt="portada-7">                
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-8.jpg')}}" class="d-block w-100" alt="portada-8">                
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <img src="{{asset('img/portada-9.jpg')}}" class="d-block w-100" alt="portada-9">                
                </div>
              </div>
          ...
          <div class="container">
            <nav class="row">
              ...
              <a href="#" class="col-3 text-reset text-uppercase d-flex align-items-center">
                <img src="{{asset('img/logoHotel.png')}}" alt="{{asset('img/logoMulticines.png')}}" class="img-logo mr-5" width="150" height="80">
                MultiCine
              </a>
              <!--menu-->
              ...
              <ul class="col-3 list-unstyled">
                ...
                <li class="d-flex justify-content-between">
                  <!--facebook-->
                  <a href="https://es-la.facebook.com/" class="text-reset">
                  ...
                  <!--github-->
                  <a href="https://github.com/" class="text-reset">
                    <i class="fa-brands fa-github"></i>
                  </a>
                </li>
              </ul>          
            </nav>
            <p class="center">©hotel 2023</p>        
          </div>      
        </footer>
      </div>
